...
inputs = {
    'single_well'   :  True,
    'xml_files'     :  xml_files,
    'file_set'      :  {'Abl_D382N_T334I': xml_files},
    'protein_wells'  :  {'Abl_D382N_T334I': ['B4', 'D4', 'F4', 'H4']},
    'ligand_order'  :  ['Bosutinib', 'Bosutinib Isomer', 'Erlotinib', 'Gefitinib'],
    'buffer_wells'   :  {'Abl_D382N_T334I': ['A2', 'C2', 'E2', 'G2']},
    'section'       :  'ex280_em480_top_gain100',
    'wavelength'    :  '480',
    'Lstated'       :  np.array(ligand_conc, np.float64), # ligand concentration
    'Pstated'       :  0.25e-6 * np.ones([17],np.float64), # protein concentration, M
    'P_error'       :  0.5, # coefficient of protein concentration uncertainity (0.15 for 15% error)
