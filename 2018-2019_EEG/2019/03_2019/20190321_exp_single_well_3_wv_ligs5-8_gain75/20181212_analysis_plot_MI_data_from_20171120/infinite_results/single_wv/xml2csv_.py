...
> python xml2csv_.py --type spectra *.xml""")
...
def process_files_five(xml_files):
    ...
    print("****This script is about to make csv files for %s xml files. ****"  % so_many)
    ...
    for file in xml_files:
        ...
        for i, sect in enumerate(Sections):
           ...
           # Extract Parameters for this section.
            ...
            dataframe = pd.DataFrame(data, index=well_order)
        ...
        large_dataframe.append(dataframe)
    return
