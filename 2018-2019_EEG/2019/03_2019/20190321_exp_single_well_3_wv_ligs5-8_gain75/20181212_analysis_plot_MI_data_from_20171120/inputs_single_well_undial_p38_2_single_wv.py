...
inputs = {
    'single_well'   :  True,
    'xml_files'     :  xml_files,
    'file_set'      :  {'undialyzed p38_2': xml_files},
    'protein_wells'  :  {'undialyzed p38_2': ['A9','B9','C9','D9','E9','F9','G9','H9']},
    'ligand_order'  :  ['Bosutinib','Bosutinib Isomer','Gefitinib','Erlotinib','Ponatinib','Lapatinib','Pazopanib','Axitinib'],
    'buffer_wells'   :  {'undialyzed p38_2': ['A10','B10','C10','D10','E10','F10','G10','H10']},
