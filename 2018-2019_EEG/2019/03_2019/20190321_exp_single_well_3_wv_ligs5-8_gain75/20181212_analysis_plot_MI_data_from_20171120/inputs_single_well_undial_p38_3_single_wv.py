...
inputs = {
    'single_well'   :  True,
    'xml_files'     :  xml_files,
    'file_set'      :  {'undialyzed p38_3': xml_files},
    'protein_wells'  :  {'undialyzed p38_3': ['A11','B11','C11','D11','E11','F11','G11','H11']},
    'ligand_order'  :  ['Bosutinib','Bosutinib Isomer','Gefitinib','Erlotinib','Ponatinib','Lapatinib','Pazopanib','Axitinib'],
    'buffer_wells'   :  {'undialyzed p38_3': ['A10','B10','C10','D10','E10','F10','G10','H10']},
