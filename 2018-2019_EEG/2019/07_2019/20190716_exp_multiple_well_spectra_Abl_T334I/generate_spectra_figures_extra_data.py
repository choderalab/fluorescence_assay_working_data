...
file = "infinite_results/Abl_D382N_T334I_Bos_UV_20190716_135721.xml"
ligands = ['Bosutinib']
plot_spectra_grid_advanced_inset(file,'Abl D382N_T334I',ligands,'Bosutinib',1,ylim,lines,Lstated)
plt.savefig('Abl_D382N_T334I-Bosutinib-log-inset.png',dpi=500)
plt.savefig('Abl_D382N_T334I-Bosutinib-log-inset.pdf')

file = "infinite_results/Abl_D382N_T334I_Bos_Iso_UV_20190716_143313.xml"
ligands = ['Bosutinib Isomer']
plot_spectra_grid_advanced_inset(file,'Abl D382N_T334I',ligands,'Bosutinib Isomer',1,ylim,lines,Lstated)
plt.savefig('Abl_D382N_T334I-Bosutinib Isomer-log-inset.png',dpi=500)
plt.savefig('Abl_D382N_T334I-Bosutinib Isomer-log-inset.pdf')

file = "infinite_results/Abl_D382N_T334I_Erl_UV_20190716_151055.xml"
ligands = ['Erlotinib']
plot_spectra_grid_advanced_inset(file,'Abl D382N_T334I',ligands,'Erlotinib',1,ylim,lines,Lstated)
plt.savefig('Abl_D382N_T334I-Erlotinib-log-inset.png',dpi=500)
plt.savefig('Abl_D382N_T334I-Erlotinib-log-inset.pdf')

file = "infinite_results/Abl_D382N_T334I_Gef_UV_20190716_154656.xml"
ligands = ['Gefitinib']
plot_spectra_grid_advanced_inset(file,'Abl D382N_T334I',ligands,'Gefitinib',1,ylim,lines,Lstated)
plt.savefig('Abl_D382N_T334I-Gefitinib-log-inset.png',dpi=500)
plt.savefig('Abl_D382N_T334I-Gefitinib-log-inset.pdf')
